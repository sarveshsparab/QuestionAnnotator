...
public class StopWordPunc {
	...
	public List<String> removeStop(List<String> words){
		helper.printVerbose(verbose, "StopWord Removal Starts....");
		...
		helper.printVerbose(verbose, "StopWord Removal Ends....");
		return afterRemoval;
	}
	
	private String[] puncs = {"?", "!", "'", "\"", "," , "_", "-" , "." , "*" , "$", "%"};
	private Set<String> puncsSet = new HashSet<String>(Arrays.asList(puncs));
	
	public List<String> removePunc(List<String> words){
		helper.printVerbose(verbose, "Punctuation Removal Starts....");
		List<String> afterRemoval = new LinkedList<String>();
		Iterator<String> itr = words.iterator(); 	
		while(itr.hasNext()) {
	         String element = itr.next();
		...
		helper.printVerbose(verbose, "Punctuation Removal Ends....");
		return afterRemoval;
	}
}
